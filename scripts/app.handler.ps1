...
# Wish there was a better way to connect, as the above takes ages to complete.
...
try {
  ...
  # If something went wrong, call the error API https://docs.aws.amazon.com/lambda/latest/dg/runtimes-api.html#runtimes-api-invokeerror
  $errorResponse = @{
